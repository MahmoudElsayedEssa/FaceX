...
class ViewFacesOverlayView(context: Context?, attrs: AttributeSet?) : View(context, attrs) {

    private var detectedFaces: List<TrackedFace> = emptyList()
...
//        }
    ...
    fun setResults(detectedFaces: List<TrackedFace>) {
...
//        this.recognizedPersons = recognizedPersons
    ...
    companion object {
        ...
        private const val IMAGE_WIDTH = 480f
        private const val IMAGE_HEIGHT = 360f
    }
}
